...
# taxi_fare_prediction_kedro documentation build
...
from taxi_fare_prediction_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "taxi_fare_prediction_kedro"
author = "Kedro"
...
htmlhelp_basename = "taxi_fare_prediction_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "taxi_fare_prediction_kedro.tex",
        "taxi_fare_prediction_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "taxi_fare_prediction_kedro",
        "Project taxi_fare_prediction_kedro codebase.",
        "Data-Science",
    )
]
